The given code implements three CPU scheduling algorithms in C programming language:

First Come First Serve (FCFS), Shortest Remaining Time First (SRTF), and Round Robin (RR). 
The code takes input in the form of an array 'process' that stores the process id, arrival time, and burst time of 'n' processes.
